 ...
 * @brief Thermocouple Controller Implementation
 ...
 * @return PAPYRUS_OK on success
 */
papyrus_status_t tc_read_temperature(tc_controller_t* tc_ctrl, 
                                    uint8_t tc_id, 
                                    int16_t* temperature_c);
 ...
 * @return PAPYRUS_OK on success
 */
papyrus_status_t tc_read_raw_voltage(tc_controller_t* tc_ctrl, 
                                    uint8_t tc_id, 
                                    int32_t* voltage_uv);
 ...
 * @return PAPYRUS_OK on success
 */
papyrus_status_t tc_read_conversion(tc_controller_t* tc_ctrl, 
                                   uint8_t tc_id, 
                                   uint32_t* raw_data);
 ...
 */
int16_t tc_apply_filter(tc_controller_t* tc_ctrl, uint8_t tc_id, int16_t raw_temp);
 ...
 */
int16_t tc_compensate_cjc(tc_controller_t* tc_ctrl, 
                         uint8_t tc_id, 
 ...
 * @return PAPYRUS_OK on success
 */
papyrus_status_t tc_update_statistics(tc_controller_t* tc_ctrl, 
                                     uint8_t tc_id, 
                                     int16_t temperature);
 ...
 * @return PAPYRUS_OK on success
 */
papyrus_status_t tc_set_alarm_limits(tc_controller_t* tc_ctrl, 
                                    uint8_t tc_id,
                                    int16_t low_limit, 
                                    int16_t high_limit);
 ...
 * @return PAPYRUS_OK on success
 */
papyrus_status_t tc_set_type(tc_controller_t* tc_ctrl, 
                            uint8_t tc_id, 
                            tc_type_t tc_type);
 ...
 * @return PAPYRUS_OK on success
 */
papyrus_status_t tc_set_sample_rate(tc_controller_t* tc_ctrl, uint16_t sample_rate_hz);
 ...
 * @return PAPYRUS_OK on success
 */
papyrus_status_t tc_calibrate(tc_controller_t* tc_ctrl, 
                             uint8_t tc_id, 
 ...
 * @return PAPYRUS_OK on success
 */
papyrus_status_t tc_set_calibration(tc_controller_t* tc_ctrl, 
                                   uint8_t tc_id,
                                   float gain, 
                                   float offset);
 ...
 * @return PAPYRUS_OK on success
 */
papyrus_status_t tc_send_single_reading(tc_controller_t* tc_ctrl, uint8_t tc_id);
 ...
 * @return PAPYRUS_OK on success
 */
papyrus_status_t tc_get_temp_range(tc_type_t tc_type, 
                                  int16_t* min_temp_c, 
                                  int16_t* max_temp_c);
 ...
 */
bool tc_validate_temperature(tc_controller_t* tc_ctrl, 
                            uint8_t tc_id, 
                            int16_t temperature);
