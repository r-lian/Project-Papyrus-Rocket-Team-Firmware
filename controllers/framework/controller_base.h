 ...
 */
controller_state_t controller_base_get_state(const controller_base_t* controller);
 ...
 * @return PAPYRUS_OK on success
 */
papyrus_status_t controller_handle_emergency_stop(controller_base_t* controller);
 ...
 * @return PAPYRUS_OK on success
 */
papyrus_status_t controller_handle_safe_mode_enter(controller_base_t* controller);
 ...
 * @return PAPYRUS_OK on success
 */
papyrus_status_t controller_handle_safe_mode_exit(controller_base_t* controller);
 ...
 * @return PAPYRUS_OK on success
 */
papyrus_status_t controller_enable_debug(controller_base_t* controller, uint8_t level);
