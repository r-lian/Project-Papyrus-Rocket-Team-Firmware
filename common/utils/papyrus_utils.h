...
papyrus_status_t papyrus_log_error(error_code_t error_code,
                                   board_id_t source_board, uint16_t error_data,
 ...
 */
papyrus_status_t papyrus_get_error_by_index(uint16_t index,
 ...
 * @return PAPYRUS_OK on success
 */
papyrus_status_t papyrus_config_load(uint16_t config_id, void *data,
                                     size_t size);
 ...
 * @return PAPYRUS_OK on success
 */
papyrus_status_t papyrus_config_save(uint16_t config_id, const void *data,
                                     size_t size);
