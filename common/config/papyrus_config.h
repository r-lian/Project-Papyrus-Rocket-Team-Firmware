...
#define IS_VALID_SERVO_POS(pos)                                                \
  ((pos) >= SERVO_POSITION_MIN && (pos) <= SERVO_POSITION_MAX)
...
#define SERVO_US_TO_POSITION(us)                                               \
  (((us) - SERVO_PULSE_MIN_US) * SERVO_POSITION_MAX /                          \
   (SERVO_PULSE_MAX_US - SERVO_PULSE_MIN_US))
#define SERVO_POSITION_TO_US(pos)                                              \
  (SERVO_PULSE_MIN_US +                                                        \
   ((pos) * (SERVO_PULSE_MAX_US - SERVO_PULSE_MIN_US) / SERVO_POSITION_MAX))
